    ...
    <div class="modal-container" id="modal_container">
                    <div class="modal">
                                <?php
                                    include('connect.php');
                                    $current_user = $_SESSION['user_id'];
                                    $u_ = "SELECT * FROM contract";
                                    $user_ = mysqli_query($conn,$u_);
                                        $sql_ = "SELECT * FROM contract ";
                                        $abc = mysqli_query($conn,$sql_);
                                        if($user_){
                                            $aaa = $abc->fetch_assoc();
                                            ?>
                                                <h1><?php echo $aaa["topic"]; ?> </h1></td>
                                                <p><?php echo $aaa["detail"]; ?></p>
