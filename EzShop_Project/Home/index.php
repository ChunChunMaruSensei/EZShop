...
<body>
    ...
    <nav>
        ...
        <div class="navigation">
            ...
            <!--menu------->
            <ul class="menu">
                <li><a href="http://localhost/ezshop/Product_reg/index.php"><b>ลงทะเบียนสินค้า</b></a></li>
            ...
            <div class="right-menu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="http://localhost/ezshop/seller_reg/seller_reg.html">ลงทะเบียนผู้ขาย</a>
                    </div>
                </div>
                <!--cart-icon----->
                                ...
                                while($row = $user->fetch_assoc()){
                                    ...
                                    <div class="product-box">  
                                        <div class="product-img">
                                            ...
                                            <a href="http://localhost/ezshop/detail/detail.php">
